...
export default function RegisFormPage() {
  ...
  const cbBuyBottleOnChange = (event) => {
    ...
    if (buyBottle && buyShoes && buyCap) {
      setGotDiscounted(true);
    } else setGotDiscounted(false);
  };
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        <input className="me-2" type="checkbox" onChange={agreeBtnOnChange} />I
